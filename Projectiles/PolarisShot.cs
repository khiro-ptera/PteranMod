...
{
	public class PolarisShot : ModProjectile
	{
		...
		public override void SetDefaults()
		{
			...
			projectile.penetrate = 14;           //How many monsters the projectile can penetrate. (OnTileCollide below also decrements penetrate for bounces as well)
